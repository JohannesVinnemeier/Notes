\subsection{Regular values and transversality}
    ...
    \begin{lemma}
            Let $M,N$ be smooth manifolds where $M$ has no boundary and let $f \colon M \to N$ be a submersion. Given a submanifold $X \subseteq N$ with boundary the preimage $f^{-1}() \subseteq M$ is a submanifold with boundary 
            \[
        ...
        \end{remark}
    % To conclude this section we briefly discuss the so called vertical differential of a map, which can be useful in the context of transversality. 
