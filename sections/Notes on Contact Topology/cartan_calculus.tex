...
Now let us proof the remaining formulas of Theorem \ref{thm:cartan_calculus}.

\begin{proof}[Proof of Theorem \ref{thm:cartan_calculus}]
    Equation (\ref{eq:cartan1}) is only mentioned for the sake of completeness and we will not show it here. See for example \cite{steimle_geometrie} for a proof.
\end{proof}
