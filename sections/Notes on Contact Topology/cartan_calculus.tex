...
\subsubsection{A cooking recipe}
...
\begin{example}
    ...
    \end{align*}
    Here we used Proposition \ref{prop:lie_derivative_formula} and the Leibniz rule for the Lie derivative. Next fix all but the second occurence of $t$:
    \[
