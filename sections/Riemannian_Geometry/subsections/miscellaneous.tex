...
\begin{proof}
    Suppose that $f$ is $\lambda$-Lipschitz and assume without loss of generality that $\norm{v} = 1$. Let $\gamma \colon (-\epsilon,\epsilon) \to M$ be a geodesic with $\gamma(0) = p$ and $\gamma^\prime(0) = v$ and let $d_M, d_N$ be the Riemannina distance functions on $M,N$ respectively. Then 
    \begin{align*}
