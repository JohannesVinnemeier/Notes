...
\begin{definition}[Universal property of the exterior power]
    ...
    \[
    \pi \colon V^{\otimes k} \to \Lambda^k V,
    \]
...
\begin{remark}
    The universal property of the exterior power is very similiar to the one of the tensor product, where we think of $\pi$ as the product map $v_1\otimes \ldots \otimes v_k \mapsto v_1 \wedge \ldots \wedge v_k$. 
    In Definition \ref{linalg:def:universal_property_exterior_algebra} we think of $\psi$ as an inlcusion and of $L$ as extending the map $\psi^\prime$.
\end{remark}

\begin{lemma}
    \label{linalg:lem:universal_property_exterior_power}
    The construction of $\Lambda^k V \subseteq V^{\otimes k}$ at the beginning of the section together with the product map $\pi \colon V^{\otimes k} \to \Lambda^k V, \; v_1\otimes \ldots \otimes v_k \mapsto v_1 \wedge \ldots \wedge v_k$ satisifes the universal property in Definition \ref{linalg:def:universal_property_exterior_power}.
\end{lemma}

\begin{proof}
    First of all it follows from the graded commutativity of the wedge product, that $\pi$ vanishes on $S^k(V)$. Uniqueness is also clear. To show existence choose a basis $e_1,\ldots,e_n \in V$ of $V$. As mentioned above this yields a basis of $\Lambda^kV$ and we define $\widetilde{T}$ on this basis (necessarily) by 
    \[
...
\]
also clearly satisifies the universal property in Definition \ref{linalg:def:universal_property_exterior_power}. Hence this is also a valid and commonly used construction of the exterior power. With this definition 
\[
