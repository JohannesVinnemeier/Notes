...
\end{remark}
    ...
    \begin{lemma}[Characterisation of the Whitney sum]
        ...
        Let $E_1$ and $E_2$ be vector bundles over the same base space $B$ of rank $k_1$ and $k_2$ respectively. A rank $k_1+k_2$ vector bundle $E$ over $B$ is isomorphic to $E_1 \oplus E_2$ if and only if $E_1$ and $E_2$ can be embedded into $E$ as subbundles and $E_1|_p + E_2|_p = E|_p$.
    \end{lemma}
    ...
    \begin{lemma}[Orthogonal complement bundles]
        ...
        \]
        is a subbundle and there exists a smooth orthonormal local frame around each point in $S$.
    \end{lemma}
