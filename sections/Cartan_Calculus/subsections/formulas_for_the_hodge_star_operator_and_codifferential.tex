...
\]
their $L^2$-scalar product. Usign Stoke's Theorem it then follows from (\ref{cartan_calc:eq:product_rule_with_codifferential}):
...
\begin{lemma}
    ...
    Let $M$ a an oriented Riemannian manifold, $\omega \in \Omega^\ast(M)$ and $X \in \mathscr{X}(M)$. Then 
    \[
