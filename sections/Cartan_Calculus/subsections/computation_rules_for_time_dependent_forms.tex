...
\begin{example}
    Let $X_t$ be some time dependent vector field on a manifold $M$ with flow $\phi_t$. Furthermore, let $\alpha_t$ be a smooth family of differential forms and $f_t$ a smooth family of real valued functions on $M$. We want to compute:
    \[
