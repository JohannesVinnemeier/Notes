...
\begin{definition}[Smooth family of $r$-forms]
    ...
    \]
    for smooth functions $\beta^{i_1,\ldots,i_r}$. If $I$ is closed we call $\beta_t$ smooth if it can be extended to a smooth family $\beta^\prime_t$ indexed over some open interval $I^\prime \supseteq I$.
\end{definition}
...
\begin{proposition}[Cartan's magic formula]
    \label{cartan_cal:prop:magic_formula}
