...
\]
with $\tilde{g}_1(0) = 0 = \tilde{g}_2(0)$. So by Lemma \ref{constr_diffeo:lem:isotopy_lemma} $\tilde{g}_1$ and $\tilde{g}_2$ are isotopic $\mathrm{rel}\, \{0\}$. In particular we get a homotopy
\[
