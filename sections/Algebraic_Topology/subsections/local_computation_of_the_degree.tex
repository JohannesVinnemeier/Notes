...
In this chapter we proof the following theorem.
...
For the proof we a need a technical Lemma for constructing a certain homotopy, which is a slight modification of Lemma 5.7 in \cite{Milnor1965hcobord}.
...
\begin{proof}[Proof of Theorem \ref{alg_top:thm:local_degree}]
